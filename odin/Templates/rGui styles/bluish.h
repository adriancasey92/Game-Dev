...
static const GuiStyleProp bluishStyleProps[BLUISH_STYLE_PROPS_COUNT] = {
    { 0, 0, (int)0x9b2ad3ff },    // DEFAULT_BORDER_COLOR_NORMAL 
    { 0, 1, (int)0x251a2bff },    // DEFAULT_BASE_COLOR_NORMAL 
    { 0, 2, (int)0x9b2ad3ff },    // DEFAULT_TEXT_COLOR_NORMAL 
    { 0, 3, (int)0x002b00ff },    // DEFAULT_BORDER_COLOR_FOCUSED 
    { 0, 4, (int)0x7ed380ff },    // DEFAULT_BASE_COLOR_FOCUSED 
    { 0, 5, (int)0x002b00ff },    // DEFAULT_TEXT_COLOR_FOCUSED 
    { 0, 6, (int)0x242b15ff },    // DEFAULT_BORDER_COLOR_PRESSED 
    { 0, 7, (int)0xb2d369ff },    // DEFAULT_BASE_COLOR_PRESSED 
    { 0, 8, (int)0x242b15ff },    // DEFAULT_TEXT_COLOR_PRESSED 
    { 0, 9, (int)0xc5a9d3ff },    // DEFAULT_BORDER_COLOR_DISABLED 
    { 0, 10, (int)0x28222bff },    // DEFAULT_BASE_COLOR_DISABLED 
    { 0, 11, (int)0xc5a9d3ff },    // DEFAULT_TEXT_COLOR_DISABLED 
    { 0, 18, (int)0x9b2ad3ff },    // DEFAULT_LINE_COLOR 
    { 0, 19, (int)0x251a2bff },    // DEFAULT_BACKGROUND_COLOR 
};
